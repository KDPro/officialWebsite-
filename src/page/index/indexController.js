		...
		return {
			...
			carousel: {
				...
				definition:[{
					...
					workName: '作品展示',
					description: '我们致力于做最精致的产品，让客户满意',
					ad: '十年精品，你的第一选择'
				},{
			...
			news:[
				// {content:"精品网站建设与优化最不能忽视的就是细节架构(一)"},
				//     {content:"精品网站建设与优化最不能忽视的就是细节架构(二)"},
				// 	{content:"精品网站建设与优化最不能忽视的就是细节架构(三)"},
				// 	{content:"精品网站建设与优化最不能忽视的就是细节架构(四)"}
					]
		}
	},
	methods:{
